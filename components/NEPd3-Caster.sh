...
function NEPd3-mount() {
    ...
    if [[ -e /dev/disk/by-partlabel/Pd3Pv1 ]]; then
        ...
        sudo mount $MOUNTOPTS /dev/mapper/NEPd3_LS2 /mnt/NEPd3_Caster/LS2
...
function NEPd3-umount() {
    ...
    for i in NEPd3Vg1-NEPd3Lv1 NEPd3Pv1  NEPd3Pv2  NEPd3Pv3  NEPd3Pv4  NEPd3Pv5  NEPd3Pv6  NEPd3Pv7 NEPd3_LS2; do
